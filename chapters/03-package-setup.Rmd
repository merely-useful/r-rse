...
1. Make it easier to share your work with others and for them to easily use it.
1. Incorporating checks

1. It's actually really easy to create R packages by using the [devtools][pkg-devtools]
and [usethis][pkg-usethis] packages, so why not?

[pkg-devtools]: https://devtools.r-lib.org/
[pkg-usethis]: https://usethis.r-lib.org/
