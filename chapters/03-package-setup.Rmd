...
3. Add a LICENSE with `use_mit_license()`.

4. Add data to the package
...
* Your package passes `check()` 
    without any notes, warnings or errors.  
    *(Or if at this point there are some, we explicitly say which ones are OK)*.
* In a fresh R session, 
    after running `load_all()`, you can access the data by name.
