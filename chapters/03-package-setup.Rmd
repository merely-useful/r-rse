...
-   Text: Other configuration, e.g. to automatically populate
    `DESCRIPTION`:
    <https://usethis.r-lib.org/articles/articles/usethis-setup.html#store-default-values-for-description-fields-and-other-preferences>
