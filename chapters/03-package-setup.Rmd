...
- The folder with the R code must be named the same as the package name. For instance,
the R package usethis

TODO: Add note somewhere about how package can be installed without being on CRAN.

TODO: Add note about what installing actually means or does.
