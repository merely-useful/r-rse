...
Let's take an example. In the Console, type out this function:

```{r}
use_r("")
```

We'll provide a simple function for
...
download.file(
    ...
    destfile = here::here("data/books.zip")
)
zip::unzip(here::here("data/books.zip"), exdir = here::here("data"))
fs::file_delete(here::here("data/books.zip"))
```
