...
- Describe the importance of using a build system for validating software and how to apply it
- Understand and implement ethical guidelines when using build systems like RHub
