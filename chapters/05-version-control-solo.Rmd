...
* understand why to use version control, specifically Git
* differentiate two methods for working with Git: RStudio integration and using shell commands in Terminal
* apply the add-stage-commit process as the Git workflow for tracking changes
* view and work with commit history
* create branches
* publish repositories to GitHub and work between remote and local versions
...
### Tracking changes and viewing history in Terminal
...
* pushing
* pulling
* mention command line activities?
