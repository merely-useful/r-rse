...
- R commands implemented through `usethis` and `gert`

> popout to explain working with git on command line and with Git Desktop App

### Setting up Git in RStudio {#git-rstudio}

Reference appendix for setup

RStudio provides a Installation and Getting Started [rstudio-git]

* connecting Git and RStudio
  * ensure Git is already installed (link to installation instructions)
