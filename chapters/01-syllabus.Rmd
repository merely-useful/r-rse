...
increasingly have massive datasets or use high performance computing servers,
along with a trend for a greater demand that scientific studies be
reproducible and open. This book will teach you the tools, skills, and knowledge
necessary to make research software that is open, reproducible, sustainable, and
more rigorous. (TODO: other word?) First and foremost, the main learning goal of
this course is that you learn to **create and develop an R package**.
More specifically, the learning objectives are to:

- Explain what an R package is, how it is structured, and how to set one up.
- List and describe what some best (or good enough) practices are in package
...
building a usable package and some steps to take to achieve this type of
documentation.
...
Aside from the direct technical aspects of building an R package, the course
will also cover topics that enhance and improve the process of package development.
These learning objectives are to:

- Describe and apply effective workflows and project management tools that help
to coordinate the development of software, particularly for software that is
complex or when working in a team.
- Outline (and optionally practice) how to work productively in a small team,
that is inclusive and welcoming.
- Explain the importance of and learning to design software and documentation
...
By the end of the course, learners are expected to have the skills and knowledge
necessary to build their own packages and to, if relevant, submit these packages
to CRAN.
...
We designed this course with the below types of learners in mind, who are fictional
characters with potentially realistic backgrounds:
...
Throughout the book, you will build several packages. There is the main
one (`zipfs`) and 2 or 3 project assignment packages (see the assignment
descriptions in Appendix \@ref(course-assignments)). For two of the packages,
we have already built them so you can use them as an example and a reference
...
- A currently existing package that you'll contribute to, which is the second
project assignment.
- (Optional) A group-based package, which is the third project assignment.
