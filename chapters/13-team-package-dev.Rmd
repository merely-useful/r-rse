...
- Apply tools within GitHub for improving team work and
coordinating development of an R package
- Explicitly communicate culture and standards for
interacting with your team to build a healthy and productive working
environment

## Overview (remove this header later)

In earlier chapters (e.g.,\@ref(community-involvement)),
we discussed how to set up your project to encourage other people to use your work,
and potentially make small contributions to your code.
In this chapter,
we'll cover the next big step in project development:
using tools and creating infrastructure that will allow you to plan and work with a team of developers.
...
(moved from chapter 12 exercises) Look at some examples of packages that use GitHub Milestones and GitHub Projects. Are there situations in which one project management approach is better than the other? Which do you prefer, or which do you feel suits your project better?
    - Milestone examples:
        - [ggplot2](https://github.com/tidyverse/ggplot2/milestones)
	- FIXME: more examples?
    - Project examples:
...
described in Chapter \@ref(github-collaboration).
...
1. Depending on whether you prefer Milestones or Projects, create one for your
