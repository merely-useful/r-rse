...
understand how to interact with your project. We'll talk more in a later chapter
 (@sec-team-package-development)) about how to develop contributing guidelines
...
Label the existing issues so that each has at least one label.
  - We'll discuss using labels for project management in @sec-team-package-development)
